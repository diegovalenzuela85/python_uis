...
# num = int(input('Ingresa un numero para validar si es primo: '))
#
# if num > 1:
#     contador = 0
#     iterador = 2
#
#     while iterador < num and contador == 0:
#         modulo = num % iterador
#         print(f'El numero {num} % {iterador} = {modulo}')
#
#         if modulo == 0:
#             contador += 1
#         iterador += 1
...
# num = int(input('Escribe un numero para descomponerlo en factores primos: '))
# iterador = int(2)
#
# while num != 1:
#     if num % iterador == 0:
#         #print(f'({int(iterador)} - " "')
#         print(f"{iterador}")
#         num /= iterador
#     else:
#         iterador += 1
...
# n = int(input('Escriba cuantas sumas quieres realizar: '))
# if n >= 0:
#     i = 0
#     while n >= i:
#         # suma = n + i
#         print(f'La suma de {n} + {i} = {n + i}')
#         i += 1
# else:
